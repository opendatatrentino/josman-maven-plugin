...
public class EvalMojo extends JosmanMojo {
    ...
    /**
     * If true no evaluation is performed, and the file
     * {@link JosmanProject#TARGET_EVAL_FILEPATH}
     * is supposed to have been already generated by some other custom
     * user-defined process.
     * 
     * @since 0.8.0
     */
    @Parameter(property = "skipEval", defaultValue = "false")
    ...
    public void execute() throws MojoExecutionException {
        ...
        if (skipEval) {
            info("Skipping evaluation (found flag skipEval=true)");
            File t = new File(JosmanProject.TARGET_EVAL_FILEPATH);
            if (!t.exists()) {
                throw new MojoExecutionException(
                        "If you skip evaluation you need to manually provide the evaluation file "
                                + t.getAbsolutePath() + " !");
            }
        } else {
            try {
